...
#    cell.recompute_segment_elec_distance(segment = cell.segments[nexus_seg_index], seg_name = "nexus")
    ...
    # Save biophys
    shutil.copy2(complex_cell_biophys_hoc_name, save_folder)
    os.rename(os.path.join(save_folder, complex_cell_biophys_hoc_name), os.path.join(save_folder, complex_cell_biophys_hoc_name.split('.')[0]+'_image.hoc')
