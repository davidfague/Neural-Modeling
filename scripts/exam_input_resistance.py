...
output_folder = sys.argv[1] if len(sys.argv) > 1 else "output/FI_in_vitro2023-09-26_21-43-52/_seeds_130_90L5PCtemplate[0]_195nseg_108nbranch_0NCs_0nsyn_-1000" #"output/BenModel/"
