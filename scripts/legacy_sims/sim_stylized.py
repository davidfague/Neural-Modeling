...
if __name__ == "__main__":
    ...
    sim.submit_job(HayParameters(f"stylized-_-", h_tstop= 10000, reduce_cell = False, expand_cable = False, all_synapses_off=True, record_ecp=False, save_every_ms=1000, test_morphology = False, reduction_before_synapses=False,exc_gmax_mean_0=4.6, exc_gmax_clip=(0,30), numpy_random_state=1111, neuron_random_state=1111, use_mm=False, build_stylized=True))
