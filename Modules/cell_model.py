          ...
          for sec in self.all:
              ...
              for i, seg in enumerate(sec):
                  self.seg_info.append({ #update to have consistent naming scheme (will then need to debug plotting functions too, but should be easy)
                      'seg': seg,
                      'seg index': j,
                      'p0 x3d': self.seg_coords['p0'][j][0],
                      'p0 y3d': self.seg_coords['p0'][j][1],
                      'p0 z3d': self.seg_coords['p0'][j][2],
                      'p0.5 x3d': self.seg_coords['pc'][j][0],
                      'p0.5 y3d': self.seg_coords['pc'][j][1],
                      'p0.5 z3d': self.seg_coords['pc'][j][2],
                      'p1 x3d': self.seg_coords['p1'][j][0],
                      'p1 y3d': self.seg_coords['p1'][j][1],
                      'p1 z3d': self.seg_coords['p1'][j][2],
                      'seg diam': seg.diam,
                      'bmtk index': k,
                      'x': seg.x,
                      'sec': seg.sec,
